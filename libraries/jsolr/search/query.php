...
class JSolrSearchQuery
{
	 ...
	 *
	 * @param $query
	 *  - The current query string will be replaced with the given query.
	 * @return
	...
	public function query($query = NULL) 
	{
		...
		throw new Exception('Given $query is not a string');
	}
