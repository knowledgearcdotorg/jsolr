...
<ul>
	...
	<li>
		...
		<?php echo JHTML::link(@$this->updateUri(array(), array('ajax', 'o')), '<img src="'. JURI::base().'/media/com_jsolrsearch/images/close.png" />', array('class'=>'jsolr-del' ,'date-name' => $field['name'])) ?>
	</li>
	<?php endforeach ?>
</ul>
<?php endif ?>
