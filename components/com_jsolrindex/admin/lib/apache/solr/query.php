 ...
 * a flexible and mnemonic API. That is the niche Apache_Solr_Query attempts to fill.
 *
 ...
 *
 * This library also fully supports chains of filters. See the {@link Apache_Solr_Query::filters()} 
 * and {@link Apache_Solr_Query::mergeFilters()} methods.
 *
 *
 * @file
 *
 ...
 * a new Apache_Solr_Query object. This is the preferred method used for constructing a 
 * query against a Solr server. (If you really prefer strong OO syntax, you 
 * can forgo using this method, and use <code>new Apache_Solr_Query()</code>.)
 *
 ...
 *  ->useQueryParser(Apache_Solr_Query::QUERY_PARSER_DISMAX) // Use the DisMax parser.
 ...
 *  A Apache_Solr_Query object, initialized and ready for chaining.
 *
...
class Apache_Solr_Query {
   ...
   *
   * @param $parser
   *  The string name of the parser to use. See the Apache_Solr_Query::QUERY_PARSER_*
   *  params.
   * @return 
   *  - setter: This object
